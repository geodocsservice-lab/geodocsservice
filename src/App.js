...
export default function GeoDocsApp() {
  ...
  const translations = {
    GE: {
      ...
      whyTitle: "რატომ ჩვენ?", whyItems: ["სწრაფი გენერირება (2 წთ)", "მრავალენოვანი მხარდაჭერა", "მაქსიმალური სიზუსტე AI-თ", "სრული ანონიმურობა"],
    ...
    EN: {
      ...
      whyTitle: "Why Us?", whyItems: ["Fast Gen (2 min)", "Multilingual", "AI Accuracy", "Anonymity"],
      pricesTitle: "Pricing",
      prices: [
    ...
    RU: {
      ...
      whyTitle: "Почему мы?", whyItems: ["Быстрая генерация", "Мультиязычность", "Точность ИИ", "Анонимность"],
      pricesTitle: "Тарифы",
      prices: [
      ...
      privacyContent: "Ваша анонимность — наш приоритет. Персональные данные удаляются через 2 минуты.",
  ...
  return (
    <div style={{ backgroundColor: '#6D757D', minHeight: '100vh', color: 'white', fontFamily: 'Arial, sans-serif', paddingBottom: '120px', overflowX: 'hidden' }}>
        ...
        {activeTab === 'home' ? (
          <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '25px' }}>
              <img src={robotUrl} alt="AI Robot" style={{ width: '180px', height: 'auto', display: 'block', objectFit: 'contain' }} onError={(e) => { e.target.style.display = 'none'; }} />
            </div>
            ...
            <button style={{ backgroundColor: '#2A2A2A', width: '100%', padding: '20px', borderRadius: '20px', border: '2px dashed #FFB800', color: 'white', fontWeight: 'bold', fontSize: '16px', cursor: 'pointer', marginBottom: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', opacity: 0.9 }}>
          ...
          <div style={{ padding: '20px', textAlign: 'center' }}>
            <div style={{ backgroundColor: '#2A2A2A', padding: '40px', borderRadius: '30px' }}>
              <User size={50} color="#FFB800" style={{ marginBottom: '15px' }} />
      ...
      {showCookieConsent && (
        <div style={{ position: 'fixed', bottom: '100px', left: '20px', right: '20px', backgroundColor: '#1A1A1A', padding: '15px', borderRadius: '15px', border: '1px solid #FFB800', zIndex: 2000, textAlign: 'center' }}>
