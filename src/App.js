...
export default function GeoDocsApp() {
  ...
  const handleChatSubmit = async (e) => {
    ...
    2. ენა: უპასუხე იმ ენაზე, რა ენაზეც გწერენ (ქართულად ლათინური ასოებით მოწერილს - უპასუხე ქართული შრიფტით).
    ...
    - თუ მომხმარებელი გეკითხება, როგორ შექმნას CV, სად დააჭიროს, ან როგორ დაიწყოს პროცესი (მათ შორის კონკრეტულ ენაზე, მაგ: არგენტინულად, ინგლისურად), უპასუხე ასე: "CV-ს შესაქმნელად, გთხოვთ მთავარ გვერდზე დააჭიროთ ყვითელ ღილაკს 'AI CV 2 წუთში' ან 'ტარიფების' განყოფილებაში აირჩიოთ სასურველი ენა."
